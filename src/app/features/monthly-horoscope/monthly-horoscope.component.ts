...
@Component({
  selector: 'app-monthly-horoscope',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './monthly-horoscope.component.html',
  styleUrl: './monthly-horoscope.component.scss'
})
export class MonthlyHoroscopeComponent implements OnInit {
  ...
  getZodiacSvgPath(signId: string): any {
  ...
  // Returns viewBox for zodiac sign SVG
